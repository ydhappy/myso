...
3. portable/EgoCoreAdapter.java
4. portable/EgoPortableRules.java
```
...
2. portable/EgoCoreAdapter.java 구현
3. portable/EgoPortableRules.java 규칙 확인/무기 type2 추가
4. 대상 서버의 채팅/명령/데미지/DB 위치에 연결
5. 대화 기능부터 단계별 테스트
```
