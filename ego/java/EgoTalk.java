 ...
 * 에고 대화 통합 클래스.
 *
 * 일반 채팅 처리, 장르 대화, 장르 안내, 자동 경고, 최근 대사 기록을 이 파일에서 처리한다.
 */
...
/** 최근 대사 반복 방지 헬퍼. 메모리 전용, DB 저장 없음. */
final class EgoTalkHistory {
    ...
    static String pick(PcInstance pc, String[] messages) {
    ...
    static void remember(PcInstance pc, String message) {
